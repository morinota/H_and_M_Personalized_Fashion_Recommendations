import numpy as np
import pandas as pd
from models.contentBase_image import ContentBaseImage
...
VERSION = "contentBase_image_latestMonth"
...
def main(val_week_id=104):
    ...
    # レコメンド結果を生成
    model = ContentBaseImage(transaction_train=train_df, dataset=dataset)
    model.preprocessing()
